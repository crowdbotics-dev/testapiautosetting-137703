...
class Testconnectors137703ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS137703_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS137703_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS137703"
